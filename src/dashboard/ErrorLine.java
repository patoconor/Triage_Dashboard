...
public class ErrorLine {
	...
	public ErrorLine(String fistUsername, String fistPassword, String FileID, String Date, String Time, String ServerName, String ErrorMsg, String StackMsg)
	{
	...
	private void populateFieldsInFIST()
	{
		clearExpectations();
		
		FIST Fdriver = new FIST(fistUser,fistPass,OfficeLocation,true);
    	Fdriver.loginProd();
